...
/* package nfatodfa-0.1.0.0 */
#ifndef VERSION_nfatodfa
#define VERSION_nfatodfa "0.1.0.0"
#endif /* VERSION_nfatodfa */
#ifndef MIN_VERSION_nfatodfa
#define MIN_VERSION_nfatodfa(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_nfatodfa */
...
#define CURRENT_COMPONENT_ID "nfatodfa-0.1.0.0-inplace-nfatodfa"
